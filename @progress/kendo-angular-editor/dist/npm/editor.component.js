    ...
    Object.defineProperty(EditorComponent.prototype, "readonly", {
        ...
        set: function (value) {
            ...
            if (this.view) {
                ...
                var tr = this.view.state.tr.setSelection(kendo_editor_common_1.TextSelection.create(doc, 1));
    ...
    EditorComponent.prototype.initialize = function () {
                ...
                new kendo_editor_common_1.Plugin({
                    ...
                    view: function () { return ({
                        update: function (editorView) {
                            if (!_this.disabled) {
                                _this.stateChange.next(_this.readonly ? editor_toolbar_state_1.disabledToolBarState : editor_toolbar_state_1.getToolbarState(editorView.state));
                            }
                        }
                    }); }
                }),
        ...
        if (this.view) {
            ...
            this.subs.add(rxjs_1.fromEvent(containerElement, 'focusin')
                .pipe(operators_1.filter(function () { return _this.readonly; }))
