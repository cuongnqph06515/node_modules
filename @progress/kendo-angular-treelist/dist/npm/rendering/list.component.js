...
var ListComponent = /** @class */ (function () {
    ...
    ListComponent.prototype.handleRowSync = function () {
        ...
        return rxjs_1.merge(this.changeNotification.changes, this.editService.changed, this.resizeService.changes, this.columnResizingService.changes, this.supportService.changes).pipe(operators_1.tap(function () { return _this.resetNavigationViewport(); }), operators_1.filter(isLocked))
            .subscribe(function () {
