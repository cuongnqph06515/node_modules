...
export declare class HeaderComponent implements AfterViewInit, OnInit, OnChanges, OnDestroy {
    ...
    constructor(popupService: SinglePopupService, hint: DragHintService, cue: DropCueService, reorderService: ColumnReorderService, sortService: SortService, localization: LocalizationService, cd: ChangeDetectorRef);
