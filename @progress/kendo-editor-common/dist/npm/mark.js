 ...
 * @hidden
 */
exports.markApplies = function (doc, ranges, type) {
    var loop = function (i) {
        var ref = ranges[i];
        var $from = ref.$from;
        var $to = ref.$to;
 ...
 * @hidden
 */
exports.toggleMark = function (markType, attrs, tr) { return function (state, dispatch) {
 ...
 * @hidden
 */
exports.removeMark = function (tr, from, to, mark) {
    if (mark === void 0) {
        mark = null;
    }
    var matched = [], step = 0;
 ...
 * @hidden
 */
exports.removeMarks = function (marks, state, dispatch, tr) {
 ...
 * @hidden
 */
exports.getParentMark = function (state, markType) {
 ...
 * @hidden
 */
exports.hasMark = function (state, options) {
    ...
    if (!result && altStyle) {
        return inline_style_1.hasStyle(state, altStyle);
    }
